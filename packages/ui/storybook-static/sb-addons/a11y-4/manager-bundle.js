try {
  (() => {
    ...
    var Nn = (e, t) => {
      for (var a in t) wn(e, a, { get: t[a], enumerable: !0 });
    };
    var $ = Se(() => {});
    var T = Se(() => {});
    var C = Se(() => {});
    ...
    var W = { VIOLATION: 'violations', PASS: 'passes', INCOMPLETION: 'incomplete' },
      ...
      se = { RESULT: Ya, REQUEST: Va, RUNNING: qa, ERROR: Ka, MANUAL: Qa, SELECT: Xa },
      ...
      nr = (e) => {
        ...
        G(
          () =>
            pt('storybook/component-test').onAllStatusChange((y, O) => {
              let S = y[g]?.[Ft],
                k = O[g]?.[Ft];
              S?.value === 'status-value:error' &&
                k?.value !== 'status-value:error' &&
        ...
        let Y = R(() => v((y) => !y), []),
          ...
          _ = j(() => s?.[c]?.every((y) => w.has(`${c}.${y.id}`)) ?? !1, [s, w, c]),
          x = R((y, O, S) => {
            y.stopPropagation();
            let k = `${O}.${S.id}`;
            D((M) => new Map(M.delete(k) ? M : M.set(k, `${k}.1`)));
          }, []),
          F = R(() => {
            D(new Map());
          }, []),
          ...
          ce = R(
            (y, O) => {
              let [S, k] = y.split('.'),
                { helpUrl: M, nodes: ye } = s?.[S]?.find((ue) => ue.id === k) || {},
                be = M && window.open(M, '_blank', 'noopener,noreferrer');
              if (ye && !be) {
                let ue =
                  ye.findIndex((ge) => O.selectors.some((kn) => kn === String(ge.target))) ?? -1;
                if (ue !== -1) {
                  let ge = `${S}.${k}.${ue + 1}`;
                  D(new Map([[`${S}.${k}`, ge]])),
                    setTimeout(() => {
          ...
          K = R(
            ({ reporters: y }) => {
              let O = y.find((S) => S.type === 'a11y');
              O && ('error' in O.result ? ne(O.result.error) : ae(O.result, g));
            },
            [ne, ae, g]
          ),
          it = R(
          ...
          Tn = R(async (y) => {
            let { createCopyToClipboardFunction: O } = await Promise.resolve().then(
              () => (Ne(), mt)
            );
            await O()(`${window.location.origin}${y}`);
          }, []),
          Cn = R((y) => Q(Dt, y), [Q]);
        G(() => {
          h(r(i));
          ...
          G(() => {
            ...
            let y = Array.from(w.values()).flatMap((S) => {
              let [k, M, ye] = S.split('.');
              if (k !== c) return [];
              let be = s?.[k]?.find((ue) => ue.id === M)?.nodes[Number(ye) - 1]?.target;
              return be ? [String(be)] : [];
            });
            Q(Le, {
              id: `${B}/selected`,
              ...
              menu: s?.[c].map((S) => {
                ...
                return [
                  { id: `${c}.${S.id}:info`, title: je(S), description: Ye(S), selectors: k },
                  {
                    id: `${c}.${S.id}`,
                    iconLeft: 'info',
                    iconRight: 'shareAlt',
            ...
            let O = s?.[c]
              .flatMap((S) => S.nodes.flatMap((k) => k.target).map(String))
    ...
    function ar(...e) {
      ...
      let a = () => {
        ...
        return function (r) {
          let i = n.reduce((l, { useScope: s, scopeName: d }) => {
            let c = s(r)[`__scope${d}`];
            return { ...l, ...c };
          }, {});
      ...
      let t = e + 'CollectionProvider',
        ...
        u = o.forwardRef((b, h) => {
          let { scope: I, children: v, ...g } = b,
            ...
            w = i(c, I);
          return (
            o.useEffect(() => (w.itemMap.set(A, { ref: A, ...g }), () => void w.itemMap.delete(A))),
    ...
    function cn({ prop: e, defaultProp: t, onChange: a = () => {} }) {
      let [n, r] = Sr({ defaultProp: t, onChange: a }),
        i = e !== void 0,
        l = i ? e : n,
        s = sn(a),
        d = R(
            ...
            m(
              ...
              N({ tabIndex: p ? 0 : -1, 'data-orientation': c.orientation }, l, {
                ...
                onKeyDown: ee(e.onKeyDown, (h) => {
                  ...
                  let I = wr(h, c.orientation, c.dir);
                  if (I !== void 0) {
                    h.preventDefault();
                    let v = u()
    ...
    function Ur(e) {
      ...
      return (
        ...
        }, [t, d]),
        {
          ...
          ref: R((c) => {
            c && (n.current = getComputedStyle(c)), a(c);
          }, []),
        }
      );
    }
    ...
    var Yr = [
      ...
      Kr = L((e, t) => {
        let {
          ...
          p = un(s),
          [u, f] = cn({ prop: n, onChange: r, defaultProp: i });
        return m(
          qr,
          {
            scope: a,
      ...
      Xr = L((e, t) => {
        ...
        return m(
          ...
          m(Te.div, N({ role: 'tablist', 'aria-orientation': i.orientation }, r, { ref: t }))
        );
      }),
      Zr = 'TabsTrigger',
      Jr = L((e, t) => {
        ...
        return m(
          Dr,
          N({ asChild: !0 }, s, { focusable: !r, active: p }),
          m(
            Te.button,
            N(
              {
    ...
    function Wt(e) {
      let { handleCopyLink: t, handleJumpToElement: a } = nt(),
        { any: n, all: r, none: i, html: l, target: s } = e,
        d = [...n, ...r, ...i];
      return o.createElement(
        o.Fragment,
        null,
...
${s} {}`
          ...
          e && e.length
            ? e.map((l) => {
                ...
                return o.createElement(
                  ...
                  o.createElement(
                    vo,
                    { onClick: (u) => i(u, a, l), 'data-active': !!c },
                    o.createElement(
                      Eo,
                      null,
    ...
    function bl(e) {
      ...
      e = dl(e);
      var a = fl.test(e);
      return a || hl.test(e) ? yl(e.slice(2), a ? 2 : 8) : pl.test(e) ? Kt : +e;
    }
    var gl = bl,
      Sl = lt,
      ze = Po,
    ...
    function xl(e, t, a) {
      ...
      function b(_) {
        var x = n,
          F = r;
        return (n = r = void 0), (c = _), (l = e.apply(F, x)), l;
      }
      function h(_) {
      ...
      function A(_) {
        return (s = void 0), f && n ? b(_) : ((n = r = void 0), l);
      }
      function Y() {
        s !== void 0 && clearTimeout(s), (c = 0), (n = d = r = s = void 0);
      }
      function w() {
        return s === void 0 ? l : A(ze());
      }
      function D() {
        var _ = ze(),
          x = v(_);
            ...
            if (!(!f && !h)) {
              ...
              c.forEach(function (g) {
                var A = (g && g.contentRect) || {},
                  ...
                  w = A.height,
                  D = !n.skipOnMount && !oe();
                D && v({ width: Y, height: w }), (n.skipOnMount = !1);
              });
            }
          }),
                  ...
                  (!d && !p) ||
                    F.forEach(function (q) {
                      var te = (q && q.contentRect) || {},
                        ...
                        ae = te.height,
                        ce = !h.current && !oe();
                      ce && D({ width: ne, height: ae }), (h.current = !1);
                    });
                };
    ...
    var kl = E.div({ width: '100%', position: 'relative', minHeight: '100%' }),
      wl = E.button(
        ({ theme: e }) => ({
          textDecoration: 'none',
          padding: '10px 15px',
      ...
      Ll = ({ tabs: e }) => {
        let { ref: t } = Ol({ refreshMode: 'debounce', handleHeight: !1, handleWidth: !0 }),
          {
            tab: a,
            setTab: n,
            toggleHighlight: r,
      ...
      Hl = ({ discrepancy: e }) => {
        let t = Re().getDocsUrl({ subpath: Ja, versioned: !0, renderer: !0 }),
          a = j(() => {
            switch (e) {
          ...
          o.createElement(
            de,
            {
              ...
              tooltip: ({ onHide: a }) => {
                ...
                return o.createElement(we, { links: n });
              },
