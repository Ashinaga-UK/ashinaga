try {
  (() => {
    ...
    var Oe = {
      NODE_ENV: 'production',
      NODE_PATH: [
        '/Users/kimeshan/Desktop/Code/ashinaga/node_modules/.pnpm/storybook@9.0.16_@testing-library+dom@10.4.0/node_modules/storybook/bin/node_modules',
        '/Users/kimeshan/Desktop/Code/ashinaga/node_modules/.pnpm/storybook@9.0.16_@testing-library+dom@10.4.0/node_modules/storybook/node_modules',
        '/Users/kimeshan/Desktop/Code/ashinaga/node_modules/.pnpm/storybook@9.0.16_@testing-library+dom@10.4.0/node_modules',
        '/Users/kimeshan/Desktop/Code/ashinaga/node_modules/.pnpm/node_modules',
      ],
      STORYBOOK: 'true',
      PUBLIC_URL: '.',
    };
    var a = __REACT__,
      {
        ...
        StrictMode: G6,
        Suspense: q6,
        __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Y6,
        act: K6,
        cloneElement: Q6,
        createContext: De,
        createElement: S,
    ...
    var vf = __STORYBOOK_TYPES__,
      { Addon_TypesEnum: Tr } = __STORYBOOK_TYPES__;
    var wf = __STORYBOOK_API__,
      {
        ActiveTabs: Cf,
        Consumer: Sf,
        ManagerContext: xf,
        ...
        addons: ga,
        combineParameters: Mf,
        controlOrMetaKey: Af,
        controlOrMetaSymbol: Lf,
        eventMatchesShortcut: Tf,
        eventToShortcut: Zf,
        experimental_MockUniversalStore: _f,
        experimental_UniversalStore: Of,
        experimental_getStatusStore: va,
        experimental_getTestProviderStore: Sl,
        experimental_requestResponse: If,
        experimental_useStatusStore: xl,
        experimental_useTestProviderStore: Nl,
        experimental_useUniversalStore: Rf,
        internal_fullStatusStore: Bf,
        internal_fullTestProviderStore: Pf,
        internal_universalStatusStore: Vf,
        internal_universalTestProviderStore: Hf,
        isMacLike: jf,
        isShortcutTaken: Df,
        keyToSymbol: zf,
        merge: Uf,
        mockChannel: $f,
        optionOrAltSymbol: Wf,
        shortcutMatchesShortcut: Gf,
        shortcutToHumanString: qf,
        types: Yf,
        useAddonState: Fl,
        useArgTypes: Kf,
        useArgs: Qf,
    ...
    var M8 = __STORYBOOK_COMPONENTS__,
      {
        A: A8,
        ActionBar: L8,
        AddonPanel: T8,
        ...
        codeCommon: w9,
        components: C9,
        createCopyToClipboardFunction: S9,
        getStoryHref: x9,
        interleaveSeparators: N9,
        nameSpaceClassNames: F9,
        resetComponents: M9,
        withReset: A9,
    ...
    function md(e, t = {}) {
      ...
      let p = [],
        v = [],
        g = () => Fn(at() * (vd - 1)),
        y = (f, E) => o !== 'rectangles' && (f === 'circles' || yd(E));
      function w(f, E) {
        let C = g(),
          Z = y(o, C),
          F = (X, oe) => f.style.setProperty(X, oe + '');
        F('--xlp', Ir(ka(Xl(E, 90) - 180), 0, 180, -m / 2, m / 2) + 'px'),
          F('--dc', r - Fn(1e3 * at()) + 'ms');
        let V = at() < hd ? Yt(at() * fd, 2) : 0;
        F('--x1', V),
          F('--x2', -1 * V),
          F('--x3', V),
          F('--x4', Yt(ka(Ir(ka(Xl(E, 90) - 180), 0, 180, -1, 1)), 4)),
          F('--y1', Yt(at() * Ql, 4)),
          F('--y2', Yt(at() * i * (to() ? 1 : -1), 4)),
          F('--y3', Ql),
          F('--y4', Yt(gd(Ir(ka(E - 180), 0, 180, i, -i), 0), 4)),
          F('--w', (Z ? s : Fn(4 * at()) + s / 2) + 'px'),
          F('--h', (Z ? s : Fn(2 * at()) + s) + 'px');
        let D = C.toString(2).padStart(3, '0').split('');
        F('--hr', D.map((X) => +X / 2 + '').join(' ')),
          F('--r', D.join(' ')),
          F('--rd', Yt(at() * (pd - Kl) + Kl) + 'ms'),
          F('--br', Z ? '50%' : 0);
      }
      let b;
      function h() {
        (e.innerHTML = ''),
          ...
          (v = (function (f, E = [], C) {
            ...
            for (let { color: F } of E) {
              let V = _r('div');
              (V.className = `${Vl} ${C}`), V.style.setProperty('--bgc', F);
              let D = _r('div');
              Or(V, D), Or(f, V), Z.push(V);
            }
            return Z;
          })(e, p, d));
    ...
    var Kl = 200,
      ...
      Yt = (e, t = 2) => Fn((e + Number.EPSILON) * 10 ** t) / 10 ** t,
    ...
    function Hr(
      ...
      let Z = r === 10 ? 1e3 : 1024,
        ...
        V = h < 0,
        D = Math[y];
      if (typeof e != 'bigint' && isNaN(e)) throw new TypeError(xd);
      if (typeof D !== Sd) throw new TypeError(Nd);
      if (
        (V && (h = -h),
      ...
      if (h === 0) (f[0] = 0), (C = f[1] = Vr.symbol[u][t ? ao : ro][b]);
        ...
        (f[0] = D(E * X) / X),
          ...
          (C = f[1] = r === 10 && b === 1 ? (t ? Td : Zd) : Vr.symbol[u][t ? ao : ro][b]);
      }
      if (
        (V && (f[0] = -f[0]),
        ...
        l === !0
          ...
          : l.length > 0
            ...
            : s.length > 0 && (f[0] = f[0].toString().replace(lo, s)),
        n && i > 0)
      ) {
        let X = f[0].toString(),
          oe = s || (X.match(/(\D)/g) || []).pop() || lo,
          ge = X.toString().split(oe),
          fe = ge[1] || Kt,
          ce = fe.length,
          ye = i - ce;
        f[0] = `${ge[0]}${oe}${fe.padEnd(ce + ye, Id)}`;
      }
      return (
        F && (f[1] = v[b] ? v[b] : Vr.fullform[u][b] + (t ? kd : wd) + (f[0] === 1 ? Kt : Ad)),
        m === Ed ? f : m === Fd ? { value: f[0], symbol: f[1], exponent: b, unit: C } : f.join(d)
      );
    }
    var Rd = Object.create,
      ...
      Dd = (e, t, n, r) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let i of Pd(t))
            !Hd.call(e, i) &&
              i !== n &&
              U1(e, i, { get: () => t[i], enumerable: !(r = Bd(t, i)) || r.enumerable });
        return e;
      },
      ht = (e, t, n) => (
        (n = e != null ? Rd(Vd(e)) : {}),
        Dd(t || !e || !e.__esModule ? U1(n, 'default', { value: e, enumerable: !0 }) : n, e)
      ),
      Ui = At((e, t) => {
        (function (n, r) {
          typeof jd == 'function' && typeof e == 'object' && typeof t == 'object'
            ? (t.exports = r())
      ...
      {
        CHROMATIC_INDEX_URL: Yd,
        CHROMATIC_BASE_URL: pr = Yd || 'https://www.chromatic.com',
        CHROMATIC_API_URL: Kd = `${pr}/api`,
      } = Oe,
      ...
      Jd = `${U}/startBuild`,
      Xd = `${U}/stopBuild`,
      q1 = `${U}/localBuildProgress`,
      e5 = `${U}/selectedModeName`,
      t5 = `${U}/selectedBrowserId`,
      n5 = `${U}/telemetry`,
      so = `${U}/enableFilter`,
      Y1 = `${U}/removeAddon`,
      a5 = 'chromatic',
      r5 = `${U}/ChannelFetch/aborted`,
      i5 = `${U}ChannelFetch/request`,
      l5 = `${U}ChannelFetch/response`,
      o5 = {
        autoAcceptChanges: !1,
        exitOnceUploaded: !1,
        exitZeroOnChanges: !0,
      ...
      K1 = 'https://www.chromatic.com/docs/visual-tests-addon',
      ft = (e, t) => {
        let n = qt(e);
      ...
      Q1 = De(null),
      s5 = ({ children: e, value: t }) => a.createElement(Q1.Provider, { value: t }, e),
      Gi = () => ft(Q1, 'AuthState'),
      d5 = {
      ...
      qi = ({ icon: e, ...t }) =>
        a.createElement(
          ...
          a.createElement(a.Fragment, null, d5[e])
        );
    function Pa() {
      return (
        (Pa = Object.assign
    ...
    function h5(e, t, n) {
      if (J1()) return Reflect.construct.apply(null, arguments);
      var r = [null];
      r.push.apply(r, t);
    ...
    function hi(e) {
      ...
      return (
        (hi = function (n) {
          ...
          function r() {
            return h5(n, arguments, pi(this).constructor);
          }
          return (
    ...
    function $n(e, t, n, r) {
      if ((r === void 0 && (r = f5), t === 0)) return r(n, n, n);
    ...
    function X1(e) {
      ...
      var p = C5.exec(t.substring(0, 50));
      if (p) {
    ...
    function ns(e, t, n) {
      return function () {
        ...
        return r.length >= t ? e.apply(this, r) : ns(e, t, r);
      };
    }
    function as(e) {
    ...
    function _5(e, t) {
      ...
      var n = es(t);
      return ts(Pa({}, n, { lightness: rs(0, 1, n.lightness - parseFloat(e)) }));
    }
    var O5 = as(_5),
      It = O5;
    function I5(e, t) {
    ...
    var is = Ct({ from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(360deg)' } }),
      ls = Ct({ '0%, 100%': { opacity: 1 }, '50%': { opacity: 0.4 } });
    Ct({
    ...
    var P5 = se({
        animation: `${ls} 1.5s ease-in-out infinite`,
        background: P.tr5,
        color: 'transparent',
        cursor: 'progress',
      }),
      ...
      H5 = k(qi)(
        {
          ...
          display: 'block',
          verticalAlign: 'top',
          path: { fill: P.medium, animation: `${ls} 1.5s ease-in-out infinite` },
        },
        (e) => ({
      ...
      D5 = ({
        ...
        let o = a.createElement(H5, { icon: i === 'user' ? 'useralt' : 'repository', type: i }),
          s = {};
        return (
          e
            ...
            : n
              ...
              : ((s['aria-label'] = t),
                (o = a.createElement(j5, { size: r, 'aria-hidden': 'true' }, t.substring(0, 1)))),
          a.createElement(V5, { size: r, isLoading: e, src: n, type: i, ...s, ...l }, o)
        );
      },
      z5 = k.span(
        (e) =>
    ...
    var Ne = W(({ children: e, withArrow: t, ...n }, r) => {
      let i = a.createElement(
        a.Fragment,
        null,
        a.createElement(z5, { withArrow: !!t }, e, t && a.createElement(qi, { icon: 'arrowright' }))
      );
      return a.createElement(U5, { as: os, ref: r, ...n }, i);
    });
    Ne.displayName = 'Link';
    Ne.defaultProps = {
      withArrow: !1,
    ...
    var G5 = k.label((e) => ({
      ...
      Q5 = k.div((e) => ({
        ...
        '> svg': {
          ...
          ...(e.error && { animation: `${B5} 700ms ease-out`, path: { fill: P.red } }),
        },
      })),
      J5 = k.div(
        (e) =>
      ...
      uo = ({ error: e, value: t, lastErrorValue: n }) => {
      ...
      ss = W(
        (
          ...
          let [h, f] = Le(uo({ error: r, value: y, lastErrorValue: d })),
            E = `${e}-error`;
          te(() => {
            f(uo({ error: r, value: y, lastErrorValue: d }));
          }, [y, r, d]);
          let C = a.createElement(Y5, {
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(G5, { htmlFor: e, appearance: t }, s)
            ),
            a.createElement(
              Q5,
              {
              ...
              a.createElement(
                X5,
                {
                  ...
                  startOpen: !0,
                  hasChrome: !!h && !v,
                  tooltip: h && !v && a.createElement(ec, { desc: h }),
                  role: 'none',
                },
                C
              ),
    ...
    ss.displayName = 'PureInput';
    var ds = W(({ type: e, startFocused: t, ...n }, r) => {
      let [i, l] = Le(e),
        o = K(
          (u) => {
      ...
      return (
        ...
        a.createElement(ss, { ref: d, startingType: e, type: i, onActionClick: o, ...n })
      );
    });
    ...
    var nc = k.div(
      ...
      Ki = ({ active: e, activeColor: t, disabled: n, isLoading: r, theme: i }) => ({
        ...
        ...(r && { '.sbds-list-item-title': { ...P5, flex: '0 1 auto', display: 'inline-block' } }),
        ...(n && {
          cursor: 'not-allowed !important',
          '.sbds-list-item-title, .sbds-list-item-center': { color: i.color.mediumdark },
        }),
      }),
      dc = k(({ active: e, activeColor: t, isLoading: n, ...r }) => a.createElement('a', { ...r }))(
        Ki
      ),
      cc = k.span(Ki),
      uc = ac((e) =>
      ...
      Ye = ({
        ...
        let c = Sn().color[e],
          u = a.createElement(
            ...
            t && a.createElement(rc, { className: 'sbds-list-item-left' }, t),
            n && a.createElement(ic, { className: 'sbds-list-item-title' }, n),
            r && a.createElement(lc, { className: 'sbds-list-item-center' }, r),
            i && a.createElement(oc, { className: 'sbds-list-item-right' }, i)
          );
        if (o) {
          let m = uc(o);
          return a.createElement(mo, null, a.createElement(m, { activeColor: c, ...d }, u));
        }
        return a.createElement(mo, null, a.createElement(s ? dc : cc, { activeColor: c, ...d }, u));
      };
    function Pn(e) {
      function t(Z, F) {
        return (Z >>> F) | (Z << (32 - F));
    ...
    var mc = (e) => new Uint8Array(e).reduce((t, n) => t + String.fromCharCode(n), ''),
      pc = (e) => window.btoa(Array.isArray(e) ? mc(e) : e),
      po = (e) => pc(e).replace(/\+/g, '-').replace(/\//g, '_').replace(/=/g, ''),
      hc = (e) => Array.from(e.match(/.{1,2}/g) ?? [], (t) => parseInt(t, 16)),
      fc = () =>
      ...
      cs = (e) =>
        Object.entries(e)
          ...
          .join('&'),
      gc = ({ error: e }) => e === 'authorization_pending',
      vc = ({ error_description: e }) => e === 'Not OAuth beta user',
      yc = async (e) => {
        let t = po(fc()),
          n = po(hc(Pn(t))),
      ...
      bc = async ({ expires: e, device_code: t, verifier: n }) => {
        ...
        try {
          ...
          if (vc(r)) return alert('You must be a beta user to use this addon at this time.'), null;
          throw new Error();
        } catch (r) {
      ...
      hr = De(null),
      Ec = ({ children: e, value: t }) => a.createElement(hr.Provider, { value: t }, e),
      Ve = (e, t) => {
        let n = ft(hr, 'Telemetry');
      ...
      on = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        S(
          'svg',
          {
            width: t,
      ...
      hs = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        S(
          'svg',
          {
            width: t,
      ...
      Rc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        S(
          'svg',
          {
            width: t,
      ...
      jc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        S(
          'svg',
          {
            width: t,
      ...
      fs = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        S(
          'svg',
          {
            width: t,
      ...
      Dc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        S(
          'svg',
          {
            width: t,
      ...
      Uc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        S(
          'svg',
          {
            width: t,
      ...
      return K(
        (l, o) => {
          t({
            ...
            icon: a.createElement(on, { color: Cn.negative }),
            onClick: i,
          });
        },
        [t, i]
    ...
    var Mn = new Map(),
      bi = (e, t, n, r = !0) => {
        let i = () => {
            window.clearTimeout(Mn.get(e)), Mn.delete(e);
          },
          l = (...o) => {
            Mn.has(e) ? i() : r && t(...o),
              Mn.set(
                e,
                window.setTimeout(() => Mn.delete(e) && t(...o), n)
              );
          };
        return (l.cancel = i), l;
      };
    ...
    var vs = De(void 0),
      Wc = ({ children: e, addonUninstalled: t, setAddonUninstalled: n }) => {
        let r = Zt().getChannel();
      ...
      ct = k(_l)(
        ...
        ({ active: e, status: t, theme: n }) => !e && qc(n, t),
        ({ active: e, theme: t }) => {
      ...
      Es = k.div({ display: 'flex', flexDirection: 'column' }),
      Ei = k.div(({ theme: e }) => ({
        padding: 15,
        lineHeight: '18px',
      ...
      Qc = k(us)(gr),
      Jc = k(xc)(gr),
      el = k(Ji)({ marginLeft: 'auto' }),
      tl = k(ct)({ margin: -5, marginLeft: 'auto' }),
      re = k(xn)(
        {
          '&&': {
            display: 'inline-flex',
    ...
    var Xc = {
      ...
      eu = k(tl)({ position: 'absolute', right: 16, top: 10 }),
      tu = k.div(({ theme: e }) => ({
      ...
      nu = k.div({ margin: '0 auto', maxWidth: 600, width: '100%' }),
      vo = k.div(({ theme: e }) => ({
        borderBottom: `1px solid ${e.appBorderColor}`,
        marginBottom: 20,
        paddingBottom: 20,
      ...
      au = k(Ha)({ marginBottom: 10 }),
      ru = k.div({ display: 'flex', flexDirection: 'column', gap: 20 }),
      yo = k.div(({ theme: e }) => ({
        alignItems: 'center',
      ...
      bo = k.div({ display: 'flex', flexGrow: 1, flexWrap: 'wrap', gap: '5px 10px' }),
      Eo = k.div(({ theme: e }) => ({
        fontWeight: e.typography.weight.bold,
        div: { marginLeft: 5, position: 'relative', top: 2 },
      })),
      ko = k.div({ marginTop: 10 }),
      iu = k.div(({ hideBorderRadius: e, theme: t }) => ({
      ...
      lu = k.div(({ theme: e }) => ({ color: e.color.warningText })),
      wo = k.div(({ theme: e }) => ({
        color: e.base === 'dark' ? e.color.medium : e.color.dark,
        marginTop: 2,
      })),
      Co = k.div(({ warning: e, theme: t }) => ({
        alignItems: 'center',
        display: 'flex',
        backgroundColor: e
          ? t.base === 'dark'
      ...
      ws = { height: 12, margin: 2, verticalAlign: 'top', width: 12 },
      su = k(Ic)(ws),
      du = k(Mc)(ws),
      cu = ({ onClose: e }) => {
        ...
        return a.createElement(
          ...
          a.createElement(
            nu,
            null,
            a.createElement(au, null, 'Configuration'),
            o
              ? a.createElement(
                  vo,
                  null,
              ...
              a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        bo,
                        null,
                        a.createElement(Eo, null, c, ' '),
                        c in o5 && a.createElement(lu, null, '*Disabled for local builds')
                      ),
                      a.createElement(wo, null, Xc[c]?.description),
                      a.createElement(
                        ko,
                        null,
                        a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    yo,
                    null,
                    a.createElement(bo, null, a.createElement(Eo, null, 'Uninstall addon')),
                    a.createElement(
                      wo,
                      null,
                      'Removing the addon updates your Storybook configuration and uninstalls the dependency.'
                    ),
                    a.createElement(ko, null, a.createElement(re, { onClick: t }, 'Uninstall'))
                  )
                )
              )
          )
      ...
      Qt = (e) => (t, n) => ({ ...t, [e]: typeof n == 'boolean' ? n : !t[e] }),
      uu = {
        toggleDiff: Qt('diffVisible'),
        toggleFocus: Qt('focusVisible'),
        toggleConfig: Qt('configVisible'),
        toggleSettings: Qt('settingsVisible'),
        toggleWarnings: Qt('warningsVisible'),
        toggleBaselineImage: Qt('baselineImageVisible'),
      },
      mu = (e, t) => uu[t.type](e, t.payload),
      Ss = De(Cs),
      xs = De(() => {}),
      vr = () => ft(Ss, 'Controls'),
      yn = () => {
        let e = ft(xs, 'ControlsDispatch');
        return gt(
          () => ({
      ...
      pu = ({ children: e, initialState: t = Cs }) => {
        let [n, r] = Cl(mu, t);
        return a.createElement(
          Ss.Provider,
          { value: n },
    ...
    var Wn = ({ children: e, links: t, note: n, ...r }) => {
        let [i, l] = a.useState(!1),
          o = a.createElement(
            Ee,
            {
              ...
              tooltip: ({ onHide: s }) =>
                a.createElement(hu, null, a.createElement(Il, { links: t.map(Ns(s)) })),
              trigger: 'click',
              ...r,
            },
      ...
      yr = () => {
          ...
          s = [
            {
              ...
              icon: a.createElement(ps, { 'aria-hidden': !0 }),
            ...
            },
            {
              id: 'configuration',
              title: 'Configuration',
              icon: a.createElement(Nc, { 'aria-hidden': !0 }),
              onClick: () => r(),
            },
            ...(o
              ? [
                  {
                    ...
                    icon: a.createElement(hs, { 'aria-hidden': !0 }),
                    href: o
              ...
              ? [
                  {
                    id: 'logout',
                    title: 'Log out',
                    icon: a.createElement(Uc, { 'aria-hidden': !0 }),
                    onClick: () => {
                      l.unset(), t(null);
                    },
                  },
        ...
        return a.createElement(Wn, { placement: 'top', links: s }, a.createElement(Fc, null));
      };
    ...
    var fu = k.div(
      ...
      gu = k(Vn)({ alignItems: 'center', height: 40, margin: '0 10px' }),
      We = k.div(
      ...
      bu = ({ hidden: e, ignoreConfig: t, ignoreSuggestions: n, onOpen: r }) => {
        let [i] = ke(Wi),
          ...
          [s, d] = Le(() => !!localStorage.getItem(oo)),
          c = K(() => {
            d(!0), localStorage.setItem(oo, 'true');
          }, []),
          u = a.createElement(
            Ne,
            ...
            ? a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    We,
                    { push: !0 },
                    a.createElement(ct, { onClick: c }, a.createElement(Ji, null))
                  )
                )
              )
            : null;
      },
      Eu = k.div({ display: 'flex', flexDirection: 'column', height: '100%' }),
      xo = k.div(({ hidden: e, interstitial: t, theme: n }) => ({
      ...
      pe = ({
        ...
        return a.createElement(
          ...
          a.createElement(xo, { hidden: l, interstitial: i }, e),
          a.createElement(xo, { hidden: !l }, a.createElement(cu, { onClose: () => o(!1) })),
          t
        );
      },
      ne = k.div((e) => ({
      ...
      Cu = ({ value: e, placeholder: t, suffix: n }) =>
        a.createElement(
          wu,
          null,
      ...
      Su = ({ id: e, value: t, placeholder: n, suffix: r, ...i }) =>
        a.createElement(
          ku,
          null,
          a.createElement(ds, {
          ...
          a.createElement(Cu, { value: t, placeholder: n, suffix: r })
        ),
      j = k.div(
        ...
        a.createElement(
          ...
          e &&
            a.createElement(
              We,
              null,
              a.createElement(No, { onClick: e }, a.createElement(Bc, null), 'Back')
            ),
          a.createElement(
            We,
            { push: !0 },
      ...
      Tu = ({ onBack: e, onSignIn: t, onSignInWithSSO: n }) =>
        a.createElement(
          pe,
          { footer: null, ignoreConfig: !0 },
          a.createElement(nl, { onBack: e }),
...
`),
    ...
    function mt() {
      var e;
      if ((e = Re(Fs))) return { kind: 'Name', value: e };
    }
    var Ou = /(?:null|true|false)/y,
      Ms = /\$[_A-Za-z]\w*/y,
      Iu = /-?\d+/y,
      Ru = /(?:\.\d+)?[eE][+-]?\d+|\.\d+/y,
      Bu = /\\/g,
    ...
    function ja(e) {
      ...
      } else if ((n = Re(Fs))) t = { kind: 'EnumValue', value: n };
      else if ((n = Re(Pu))) t = { kind: 'StringValue', value: _u(n.slice(3, -3)), block: !0 };
      else if ((n = Re(Vu)))
        t = { kind: 'StringValue', value: Bu.test(n) ? JSON.parse(n) : n.slice(1, -1), block: !1 };
      else if (
        (t =
          (function (i) {
            var l;
    ...
    function sn(e) {
      ...
      for (J(); ue.charCodeAt(q) === 64; ) {
        ...
        J(), t.push({ kind: 'Directive', name: n, arguments: As(e) });
      }
      return t;
    }
    function Hu() {
    ...
    function zu() {
      if (Re(Du)) {
        ...
        var e = q,
          t;
        if ((t = mt()) && t.value !== 'on')
          return { kind: 'FragmentSpread', name: t, directives: sn(!1) };
        q = e;
        var n = Ts(),
          r = sn(!1),
          i = Er();
        ...
        (n = (function () {
          ...
          if ((J(), ue.charCodeAt(q) === 40)) {
            for (q++, J(); (l = Re(Ms)); ) {
              ...
              var s = Ls(),
                d = void 0;
              if (ue.charCodeAt(q) === 61 && (q++, J(), !(d = ja(!0))))
...
`)
  ...
  `
        ...
        StringValue: (e) => (e.block ? Ku(e.value) : Yu(e.value)),
...
`)
  ...
  `
    ...
    var Fo = () => (typeof Symbol == 'function' && Symbol.asyncIterator) || '@@asyncIterator',
      Qu = (e) => e;
    function Ze(e) {
      return (t) => (n) => {
        var r = Pe;
    ...
    function Si() {
      var e, t;
      return {
        source: qn(Is((n) => ((e = n.next), (t = n.complete), al))),
        next(n) {
          e && e(n);
        },
        complete() {
...
`),
      ...
      Xt = (e) => {
        ...
        if (e.toJSON) return Xt(e.toJSON());
        if (Array.isArray(e)) {
          var t = '[';
          for (var n of e) t.length > 1 && (t += ','), (t += Xt(n) || 'null');
          return (t += ']');
        } else if (($a !== cn && e instanceof $a) || (Wa !== cn && e instanceof Wa)) return 'null';
        ...
        if (
          ...
          var i = Lo.get(e) || Math.random().toString(36).slice(2);
          return Lo.set(e, i), Xt({ __key: i });
        }
        Pt.add(e);
        var l = '{';
        for (var o of r) {
          var s = Xt(e[o]);
          s && (l.length > 1 && (l += ','), (l += Xt(o) + ':' + s));
        }
      ...
      Ua = (e) => (Pt.clear(), Xt(e)),
      cn = class {},
      $a = typeof File < 'u' ? File : cn,
      Wa = typeof Blob < 'u' ? Blob : cn,
      r2 = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g,
      i2 = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g,
      l2 = (e, t) =>
        t % 2 == 0
...
`
          ...
          : e,
      To = (e) => e.split(r2).map(l2).join('').trim(),
      Zo = new Map(),
      Ra = new Map(),
      ol = (e) => {
        var t;
...
# ${n}`,
      ...
      o2 = (e) => {
        ...
        return (
          typeof e == 'string'
            ? ((t = _o(e)), (n = Ra.get(t) || qu(e)))
            : ((t = e.__key || _o(e)), (n = Ra.get(t) || e)),
          n.loc || ol(n),
          (n.__key = t),
          Ra.set(t, n),
          n
      ...
      Rs = (e) => {
        for (var t of e.definitions)
          if (t.kind === Zu.OPERATION_DEFINITION) return t.name ? t.name.value : void 0;
      },
      Oo = (e, t, n) => {
      ...
      Fi = (e, t) => {
        if (
          ...
          for (var n of Object.keys(t)) e[n] = Fi(e[n], t[n]);
          return e;
        }
        return t;
      },
          ...
          var c = function (m) {
            ...
            if (m.items)
              for (var h = +p >= 0 ? p : 0, f = 0, E = m.items.length; f < E; f++)
                v[h + f] = Fi(v[h + f], m.items[f]);
            else m.data !== void 0 && (v[p] = Fi(v[p], m.data));
          };
          for (var u of s) c(u);
    ...
    var c2 = (e, t) => {
      ...
      u2 = (e, t) => {
        if (t && !(e.kind === 'query' && e.context.preferGetMethod)) {
          var n = Ua(t),
            r = ((s) => {
              var d = new Map();
              return ($a !== cn || Wa !== cn) && (Pt.clear(), Ni(d, 'variables', s)), d;
            })(t.variables);
          if (r.size) {
            var i = new FormData();
      ...
      h2 = /boundary="?([^=";]+)"?/i,
      f2 = /data: ?([^\n]+)/,
      Io = (e) => (e.constructor.name === 'Buffer' ? e.toString() : p2.decode(e));
    async function* Ro(e) {
      if (e.body[Symbol.asyncIterator]) for await (var t of e.body) yield Io(t);
      else {
        var n = e.body.getReader(),
          r;
        try {
          for (; !(r = await n.read()).done; ) yield Io(r.value);
        } finally {
          n.cancel();
        }
      }
...
`
    ...
    var Mi = (e, t) => {
      ...
      if (Array.isArray(e)) return e.map((i) => Mi(i));
    ...
    var y2 = () => {},
        ...
        (n) => {
          var r = Da((l) => {
              var o = d2(l),
                s = c2(l, o),
                d = m2(l, o),
                c = Zs(Ze((u) => u.kind === 'teardown' && u.key === l.key)(n))(v2(l, s, d));
              return c;
            })(
              Ze(
                (l) =>
      ...
      C2 = function e(t) {
        ...
        var p = (h) => {
            var f = Zs(Ze((E) => E.kind === 'teardown' && E.key === h.key)(d.source))(
              Ze(
                (E) =>
            ...
            return (
              t.maskTypename && (f = wi((E) => ({ ...E, data: Mi(E.data, !0) }))(f)),
              h.kind !== 'query'
                ? (f = _s((E) => !!E.hasNext, !0)(f))
                : (f = Mo((E) => {
                    var C = jn(E);
          ...
          g = Object.assign(v, {
                ...
                : Po(
                    Xu(() => {
                      ...
                      return h.kind === 'query' && E && (E.stale || E.hasNext)
                        ? Mo(jn)(Gn([f, Ze((C) => C === r.get(h.key))(jn(E))]))
                        : f;
                    })
                  );
            },
            ...
            query: (h, f, E) => g.executeQuery(an(h, f), E),
            subscription: (h, f, E) => g.executeSubscription(an(h, f), E),
            mutation: (h, f, E) => g.executeMutation(an(h, f), E),
          }),
          y = y2,
          w = E2(t.exchanges),
          b = qn(w({ client: g, dispatchDebug: y, forward: w2({ dispatchDebug: y }) })(d.source));
        return n2(b), g;
      },
      S2 = {},
      wr = De(S2),
    ...
    var sl = () => {
      ...
      $r = (e, t) => {
        ...
        return ((r, i) => {
          ...
          for (var o in i) if (o === 'operation' ? !N2(r[o], i[o]) : r[o] !== i[o]) return !0;
          return !1;
        })(e, n)
          ? n
          : e;
    ...
    function dl(e) {
      var t = sl(),
        ...
        u = d[1];
      l !== d[0] && F2(d[2], s) && c([l, (u = $r(d[1], o(l, r))), s]),
        te(() => {
          var p = d[0],
            v = d[2][1],
            g = !1,
          ...
          function p() {
            c = Promise.resolve()
              .then(() =>
                e({
                  mutate(b, h, f) {
                    var E = t.createRequestOperation('mutation', an(b, h), f);
                    return il(
                      kr(1)(
                        Ze(
                          (C) =>
    ...
    var G2 = typeof crypto < 'u' && crypto.randomUUID && crypto.randomUUID.bind(crypto),
      Vo = { randomUUID: G2 };
    function q2(e, t, n) {
      if (Vo.randomUUID && !t && !e) return Vo.randomUUID();
      e = e || {};
      let r = e.random ?? e.rng?.() ?? W2();
    ...
    var Y2 = q2,
      ...
      Ya = (e) => {
        ...
        lt ? localStorage.setItem(ui, lt) : localStorage.removeItem(ui);
      };
    Ya(localStorage.getItem(ui));
    var Vs = () => {
        let [{ token: e }, t] = Fl(`${U}/accessToken`, { token: lt }),
          n = a.useCallback(
            (r) => {
              Ya(r), t({ token: lt });
            },
      ...
      Q2 = ({ children: e, value: t = js() }) => a.createElement(x2, { value: t }, e),
      ae;
    (function (e) {
      e.assertEqual = (i) => i;
      function t(i) {}
    ...
    var Me = class {
      ...
      zs = (e) => ({ status: 'dirty', value: e }),
      Ae = (e) => ({ status: 'valid', value: e }),
      Ti = (e) => e.status === 'aborted',
      Zi = (e) => e.status === 'dirty',
      Kn = (e) => e.status === 'valid',
      Ja = (e) => typeof Promise < 'u' && e instanceof Promise,
      R;
    (function (e) {
    ...
    var Y = class {
        ...
        _parseSync(e) {
          let t = this._parse(e);
          if (Ja(t)) throw new Error('Synchronous parse encountered promise.');
          return t;
        }
        _parseAsync(e) {
          let t = this._parse(e);
        ...
        async safeParseAsync(e, t) {
          let n = {
            ...
            i = await (Ja(r) ? r : Promise.resolve(r));
          return Ho(n, i);
        }
        refine(e, t) {
          let n = (r) =>
        ...
        brand() {
          return new $s({ typeName: H.ZodBranded, type: this, ...$(this._def) });
        }
        catch(e) {
          let t = typeof e == 'function' ? e : () => e;
      ...
      rm = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
      im = /^(?!\.)(?!.*\.\.)([A-Z0-9_+-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
    ...
    function cm(e, t) {
      return !!(((t === 'v4' || !t) && om.test(e)) || ((t === 'v6' || !t) && sm.test(e)));
    }
    ...
    Qn.create = (e) => new Qn({ typeName: H.ZodBoolean, coerce: e?.coerce || !1, ...$(e) });
    ...
    un.create = (e) =>
      new un({ checks: [], coerce: e?.coerce || !1, typeName: H.ZodDate, ...$(e) });
    ...
    Jn.create = (e) => new Jn({ typeName: H.ZodUndefined, ...$(e) });
    ...
    mn.create = (e) => new mn({ typeName: H.ZodAny, ...$(e) });
    ...
    function en(e) {
      if (e instanceof he) {
        ...
        return e instanceof ut
          ? new ut({ ...e._def, type: en(e.element) })
          : e instanceof bt
            ? bt.create(en(e.unwrap()))
            : e instanceof zt
              ? zt.create(en(e.unwrap()))
              : e instanceof wt
                ? wt.create(e.items.map((t) => en(t)))
                : e;
    }
    var he = class extends Y {
      ...
      keyof() {
        return Us(ae.objectKeys(this.shape));
      }
    };
    he.create = (e, t) =>
      new he({
    ...
    var tr = class extends Y {
        ...
        static create(e, t, n) {
          return t instanceof Y
            ...
            : new tr({ keyType: ot.create(), valueType: e, typeName: H.ZodRecord, ...$(t) });
        }
      },
      nr = class extends Y {
        get keySchema() {
    ...
    var pn = class extends Y {
      ...
      min(e, t) {
        return new pn({ ...this._def, minSize: { value: e, message: R.toString(t) } });
      }
      max(e, t) {
        return new pn({ ...this._def, maxSize: { value: e, message: R.toString(t) } });
      }
      size(e, t) {
    ...
    pn.create = (e, t) =>
      new pn({ valueType: e, minSize: null, maxSize: null, typeName: H.ZodSet, ...$(t) });
    var zn = class extends Y {
        ...
        args(...e) {
          return new zn({ ...this._def, args: wt.create(e).rest(Vt.create()) });
        }
        returns(e) {
      ...
      _parse(e) {
        if (typeof e.data != 'string') {
          let t = this._getOrReturnCtx(e),
            n = this._def.values;
          return (
            T(t, { expected: ae.joinValues(n), received: t.parsedType, code: x.invalid_type }), z
          );
        }
    ...
    var ra = class extends Y {
      _parse(e) {
        ...
        if (n.parsedType !== M.string && n.parsedType !== M.number) {
          ...
          return (
            T(n, { expected: ae.joinValues(r), received: n.parsedType, code: x.invalid_type }), z
          );
        }
    ...
    hn.create = (e, t) => new hn({ type: e, typeName: H.ZodPromise, ...$(t) });
...
`),
            ...
            async (y) => {
              if ((y.message === 'login' && u.current?.(d), y.message === 'grant'))
                try {
                  ...
                  c.current = w;
                  let b = Hs(w),
                    { data: h } = await l.query(Jm, {}, { fetchOptions: b });
      ...
      a4 = k.div({ display: 'flex', gap: 8 }),
      r4 = k.div({ display: 'flex', flexDirection: 'column', gap: 8 }),
      i4 = k.div(({ theme: e }) => ({
        display: 'flex',
        flexDirection: 'column',
        maxWidth: 400,
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                null,
                a.createElement(e4, null, 'Visual tests in Storybook'),
                a.createElement(
                  j,
                  { muted: !0 },
      ...
      s4 = ({ setAccessToken: e, setCreatedProjectId: t, hasProjectId: n }) => {
        ...
        if (r === 'welcome' && !n)
          return a.createElement(o4, { onNext: () => i('signin'), onUninstall: d });
        ...
        if (r === 'subdomain')
          return a.createElement(Au, { onBack: () => i('signin'), onSignIn: u });
        if (r === 'verify') {
...
`,
      ...
      Kr = k(c4)(({ theme: e }) => ({
        ...
        padding: 4,
        borderRadius: '50%',
        animation: `${u4} 3.72s ease infinite`,
      ...
      Qr = k.div({ width: '100%', display: 'flex', flexDirection: 'column', gap: 8 }),
      Na = k.pre(({ theme: e }) => ({
        margin: 0,
        padding: '10px 12px',
        fontSize: '12px',
...
`),
      v4 = ({ projectId: e, configFile: t, goToNext: n }) => {
        Ve('LinkProject', 'LinkedProject');
        let [{ data: r, fetching: i, error: l }] = dl({ query: g4, variables: { projectId: e } });
        return a.createElement(
          pe,
          {
            footer: a.createElement(
              ...
              a.createElement(We, { push: !0 }, a.createElement(yr, null))
            ),
          },
          a.createElement(
            de,
...
`)),
    ...
    var b4 = k.div(({ theme: e }) => ({
      ...
      E4 = 'https://www.chromatic.com/docs/visual-tests-addon/#configure';
    function k4({ projectId: e, configFile: t }) {
      return (
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                Ne,
                { secondary: !0, withArrow: !0, target: '_blank', href: E4 },
                "What's this for?"
              )
            )
          )
...
`),
      C4 = ({ createdProjectId: e, setCreatedProjectId: t, onUpdateProject: n }) => {
        let r = a.useCallback(
          async (i) => {
            await n(i);
          },
      ...
      Ma = k.div({ height: '100%', overflowY: 'auto' }),
      S4 = k(ne)({ width: '100%' }),
      x4 = k(D5)({ marginRight: 10 });
    function N4({ createdProjectId: e, setCreatedProjectId: t, onSelectProjectId: n }) {
      let [{ data: r, fetching: i, error: l }, o] = dl({ query: w4 });
      te(() => {
              ...
              !r &&
                ...
                a.createElement(
                  ...
                  a.createElement(
                    Do,
                    null,
                    a.createElement(Fa, null, 'Accounts'),
                    a.createElement(
                      Ma,
                      null,
                  ...
                  a.createElement(
                    zo,
                    null,
                    a.createElement(Fa, null, 'Projects'),
                    a.createElement(
                      Ma,
                    ...
                    a.createElement(
                      ...
                      r.viewer.accounts?.map((h) =>
                        a.createElement(Ye, {
                          ...
                          left: a.createElement(x4, { src: h.avatarUrl ?? void 0, size: 'tiny' }),
                          onClick: () => u(h),
                          active: s === h.id,
                        })
                      )
                      ...
                      c?.projects?.map(
                        (h) =>
                          ...
                          a.createElement(Ye, {
                            ...
                            key: h.id,
                            title: h.name,
                            right: a.createElement(Ac, { 'aria-label': h.name }),
                            onClick: () => v(h),
                            disabled: m,
                          })
                      )
    ...
    var F4 = () =>
      ...
      e0 = { isRunning: !1, startBuild: () => {}, stopBuild: () => {} },
      t0 = De(e0),
      sa = () => ft(t0, 'RunBuild'),
      L4 = ({ children: e, watchState: t = e0 }) => a.createElement(t0.Provider, { value: t }, e),
      Oi = {
    ...
    function T4(e, t) {
      return Jr[Math.max(Jr.indexOf(e), Jr.indexOf(t))];
    }
    function Z4(e) {
      let t = {};
      return (
        e?.forEach((n) => {
          ...
          t[n.story.storyId] = T4(r, Oi[n.status]);
        }),
    ...
    function _4(e, { shouldSwitchToLastBuildOnBranch: t, lastBuildOnBranchId: n, storyId: r }) {
    ...
    var $o = {
      ...
      n0 = ({ children: e, billingUrl: t, suspensionReason: n = 'OTHER' }) => {
        ...
        let { heading: r, message: i, action: l } = $o[n] || $o.OTHER;
        return a.createElement(
          pe,
          { footer: null },
          a.createElement(
    ...
    var I4 = a0('function'),
      R4 = (e) => e === null,
      Wo = (e) => Object.prototype.toString.call(e).slice(8, -1) === 'RegExp',
      Go = (e) => !B4(e) && !R4(e) && (I4(e) || typeof e == 'object'),
      B4 = a0('undefined');
    function P4(e, t) {
      let { length: n } = e;
    ...
    function Fe(e, t) {
      ...
      if (e && Go(e) && t && Go(t)) {
        ...
        if (Array.isArray(e) && Array.isArray(t)) return P4(e, t);
        if (e instanceof Map && t instanceof Map) return H4(e, t);
        if (e instanceof Set && t instanceof Set) return j4(e, t);
        if (ArrayBuffer.isView(e) && ArrayBuffer.isView(t)) return V4(e, t);
        if (Wo(e) && Wo(t)) return e.source === t.source && e.flags === t.flags;
    ...
    var D4 = [
      ...
      z4 = ['bigint', 'boolean', 'null', 'number', 'string', 'symbol', 'undefined'];
    function Sr(e) {
    ...
    var W4 = ['innerHTML', 'ownerDocument', 'style', 'attributes', 'nodeValue'];
    function A(e) {
    ...
    A.number = (e) => bn('number')(e) && !A.nan(e);
    ...
    A.primitive = (e) => A.null(e) || $4(typeof e);
    ...
    function Yo(e, t, n) {
      ...
      if (!_.nullOrUndefined(l)) {
        if (_.defined(d)) {
          if (_.array(d) || _.plainObject(d)) return q4(d, c, l);
        } else return Fe(c, l);
        return !1;
      }
      return [o, s].every(_.array)
        ...
        : [o, s].every(_.plainObject)
          ? Y4(Object.keys(d), Object.keys(c))
    ...
    function Ko(e, t, { key: n } = {}) {
      let r = st(e, n),
        i = st(t, n);
      if (!r0(r, i)) throw new TypeError('Inputs have different types');
      if (!G4(r, i)) throw new TypeError("Inputs don't have length");
      return [r, i].every(_.plainObject) && ((r = Object.keys(r)), (i = Object.keys(i))), [r, i];
    }
    function Qo(e) {
      return ([t, n]) =>
        _.array(e)
          ? Fe(e, n) || e.some((r) => Fe(r, n) || (_.array(n) && ul(n)(r)))
          : _.plainObject(e) && e[t]
            ? !!e[t] && Fe(e[t], n)
            : Fe(e, n);
    }
    ...
    function Jo(e) {
      return (t) => (_.array(e) ? e.some((n) => Fe(n, t) || (_.array(t) && ul(t)(n))) : Fe(e, t));
    }
    function An(e, t) {
      return _.array(e) ? e.some((n) => Fe(n, t)) : Fe(e, t);
    }
    function ul(e) {
    ...
    function lr(e, t) {
      ...
      return {
        added: (n, r) => {
          try {
            return Yo(e, t, { key: n, type: 'added', value: r });
          } catch {
            return !1;
          }
        },
        changed: (n, r, i) => {
          try {
            ...
            return [l, o].every(_.array) || [l, o].every(_.plainObject) ? !Fe(l, o) : l !== o;
          } catch {
            return !1;
          }
        },
        ...
        decreased: (n, r, i) => {
          if (!_.defined(n)) return !1;
          try {
            return qo(e, t, { key: n, actual: r, previous: i, type: 'decreased' });
          } catch {
            return !1;
          }
        },
        ...
        increased: (n, r, i) => {
          if (!_.defined(n)) return !1;
          try {
            return qo(e, t, { key: n, actual: r, previous: i, type: 'increased' });
          } catch {
            return !1;
          }
        },
        removed: (n, r) => {
          try {
            return Yo(e, t, { key: n, type: 'removed', value: r });
          } catch {
            return !1;
          }
        },
    ...
    var Xo = da && !!(window.MSInputMethodContext && document.documentMode),
      e1 = da && /MSIE 10/.test(navigator.userAgent);
    function En(e) {
      return e === 11 ? Xo : e === 10 ? e1 : Xo || e1;
    }
    function fn(e) {
    ...
    function rp(e) {
      var t = e.nodeName;
      return t === 'BODY' ? !1 : t === 'HTML' || fn(e.firstElementChild) === e;
    }
    function Ii(e) {
    ...
    function or(e, t) {
      ...
      if ((e !== o && t !== o) || r.contains(i)) return rp(o) ? o : fn(o);
      var s = Ii(e);
    ...
    function s0(e) {
      ...
      return { height: n1('Height', t, n, r), width: n1('Width', t, n, r) };
    }
    var lp = function (e, t) {
    ...
    function Ri(e) {
      ...
      var i = { left: t.left, top: t.top, width: t.right - t.left, height: t.bottom - t.top },
        l = e.nodeName === 'HTML' ? s0(e.ownerDocument) : {},
      ...
      if (d || c) {
        var u = $t(e);
        (d -= t1(u, 'x')), (c -= t1(u, 'y')), (i.width -= d), (i.height -= c);
      }
      return Mt(i);
    }
    function pl(e, t) {
      ...
      return (r && !n ? t.contains(s) : t === s && s.nodeName !== 'BODY') && (m = ip(m, t)), m;
    }
    function sp(e) {
      ...
      if (r === 'viewport') l = sp(o, i);
        ...
        r === 'scrollParent'
          ...
          : r === 'window'
            ...
            : (s = r);
        var d = pl(s, o, i);
        if (s.nodeName === 'HTML' && !d0(o)) {
          var c = s0(e.ownerDocument),
            u = c.height,
            m = c.width;
    ...
    function u0(e, t, n, r, i) {
      ...
      var o = hl(n, r, l, i),
        ...
        d = Object.keys(s)
          .map(function (p) {
            return $e({ key: p }, s[p], { area: dp(s[p]) });
          })
          .sort(function (p, v) {
    ...
    function h0(e, t, n) {
      ...
      var r = p0(e),
        ...
        c = l ? 'width' : 'height';
      return (
        (i[o] = t[o] + t[d] / 2 - r[d] / 2), n === s ? (i[s] = t[s] - r[c]) : (i[s] = t[sr(s)]), i
      );
    }
    function ua(e, t) {
    ...
    function f0(e, t, n) {
      var r = n === void 0 ? e : e.slice(0, cp(e, 'name', n));
      return (
    ...
    function up() {
      if (!this.state.isDestroyed) {
        ...
        (e.offsets.reference = m0(
          ...
          (e.offsets.popper = h0(this.popper, e.offsets.reference, e.placement)),
          (e.offsets.popper.position = this.options.positionFixed ? 'fixed' : 'absolute'),
          (e = f0(this.modifiers, e)),
    ...
    function y0(e, t, n, r) {
      ...
      l.addEventListener(t, n, { passive: !0 }), i || y0(ca(l.parentNode), t, n, r), r.push(l);
    }
    function pp(e, t, n, r) {
      (n.updateBound = r), v0(e).addEventListener('resize', n.updateBound, { passive: !0 });
      var i = ca(e);
      return (
        y0(i, 'scroll', n.updateBound, n.scrollParents),
        (n.scrollElement = i),
        (n.eventsEnabled = !0),
        n
      );
    ...
    function hp() {
      this.state.eventsEnabled ||
        (this.state = pp(this.reference, this.options, this.state, this.scheduleUpdate));
    }
    function fp(e, t) {
      return (
    ...
    function gp() {
      this.state.eventsEnabled &&
        (cancelAnimationFrame(this.scheduleUpdate), (this.state = fp(this.reference, this.state)));
    }
    function gl(e) {
    ...
    function yp(e) {
      return (
        ...
        vp(e.instance.popper, e.attributes),
        e.arrowElement && Object.keys(e.arrowStyles).length && Bi(e.arrowElement, e.arrowStyles),
        e
      );
    }
    function bp(e, t, n, r, i) {
      var l = m0(i, t, e, n.positionFixed),
        o = u0(n.placement, l, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
      return (
    ...
    var kp = da && /Firefox/i.test(navigator.userAgent);
    function wp(e, t) {
      var n = t.x,
        r = t.y,
        i = e.offsets.popper,
      ...
      var o = l !== void 0 ? l : t.gpuAcceleration,
        s = fn(e.instance.popper),
        d = Ri(s),
        c = { position: i.position },
        u = Ep(e, window.devicePixelRatio < 2 || !kp),
    ...
    function Cp(e, t) {
      var n;
      if (!b0(e.instance.modifiers, 'arrow', 'keepTogether')) return e;
      var r = t.element;
      if (typeof r == 'string') {
      ...
      return (
        ...
        (e.arrowElement = r),
        (e.offsets.arrow = ((n = {}), vn(n, m, Math.round(f)), vn(n, p, ''), n)),
        e
      );
    }
    function Sp(e) {
    ...
    function xp(e, t) {
      if (g0(e.instance.modifiers, 'inner') || (e.flipped && e.placement === e.originalPlacement))
        return e;
      var n = hl(
          e.instance.popper,
        ...
        o.forEach(function (s, d) {
          ...
          (p || b || C) &&
            ...
            (e.offsets.popper = $e(
              {},
              e.offsets.popper,
              h0(e.instance.popper, e.offsets.reference, e.placement)
            )),
            (e = f0(e.instance.modifiers, e, 'flip')));
        }),
        e
      );
    }
      ...
      var c = t.priority,
        ...
        m = {
          primary: function (p) {
            var v = u[p];
            return (
              u[p] < d[p] && !t.escapeWithReference && (v = Math.max(u[p], d[p])), vn({}, p, v)
            );
          },
    ...
    function Tp(e) {
      ...
      if (r) {
        var i = e.offsets,
          ...
          d = s ? 'left' : 'top',
          c = s ? 'width' : 'height',
          u = { start: vn({}, d, l[d]), end: vn({}, d, l[d] + l[c] - o[c]) };
        e.offsets.popper = $e({}, o, u[r]);
      }
      return e;
    }
    function Zp(e) {
      if (!b0(e.instance.modifiers, 'hide', 'preventOverflow')) return e;
    ...
    var Op = {
        shift: { order: 100, enabled: !0, fn: Tp },
        offset: { order: 200, enabled: !0, fn: Ap, offset: 0 },
        preventOverflow: {
          order: 300,
          enabled: !0,
          fn: Lp,
        ...
        keepTogether: { order: 400, enabled: !0, fn: Np },
        arrow: { order: 500, enabled: !0, fn: Cp, element: '[x-arrow]' },
        flip: {
          order: 600,
          enabled: !0,
          fn: xp,
        ...
        inner: { order: 700, enabled: !1, fn: _p },
        hide: { order: 800, enabled: !0, fn: Zp },
        computeStyle: {
          order: 850,
          enabled: !0,
          fn: wp,
        ...
        applyStyle: { order: 900, enabled: !0, fn: yp, onLoad: bp, gpuAcceleration: void 0 },
      },
      Ip = {
        placement: 'bottom',
        positionFixed: !1,
        ...
        function e(t, n) {
          ...
          lp(this, e),
            ...
            this.modifiers.forEach(function (o) {
              o.enabled && l0(o.onLoad) && o.onLoad(r.reference, r.popper, r.options, o, r.state);
            }),
            this.update();
    ...
    var r1 = xr,
      Pi = ht($i()),
      Rp = ['innerHTML', 'ownerDocument', 'style', 'attributes', 'nodeValue'],
      Bp = [
        'Array',
        'ArrayBuffer',
        'AsyncFunction',
      ...
      Pp = ['bigint', 'boolean', 'null', 'number', 'string', 'symbol', 'undefined'];
    function Nr(e) {
    ...
    var jp = k0('function'),
      ...
      l1 = function (e) {
        return !zp(e) && !Dp(e) && (jp(e) || typeof e == 'object');
      },
      zp = k0('undefined'),
      Vi = function (e) {
    ...
    function _e(e, t) {
      ...
      if (e && l1(e) && t && l1(t)) {
        ...
        if (e instanceof Map && t instanceof Map) return Wp(e, t);
        if (e instanceof Set && t instanceof Set) return Gp(e, t);
        if (ArrayBuffer.isView(e) && ArrayBuffer.isView(t)) return $p(e, t);
    ...
    function s1(e, t, n) {
      ...
      if (!I.nullOrUndefined(l)) {
        if (I.defined(d)) {
          if (I.array(d) || I.plainObject(d)) return Yp(d, c, l);
        } else return _e(c, l);
        return !1;
      }
      return [o, s].every(I.array)
        ...
        : [o, s].every(I.plainObject)
          ? Kp(Object.keys(d), Object.keys(c))
    ...
    function d1(e, t, n) {
      ...
      if (!qp(l, o)) throw new TypeError("Inputs don't have length");
    ...
    function Qp(e, t) {
      ...
      var n = function (m, p) {
          try {
            return s1(e, t, { key: m, type: 'added', value: p });
          } catch {
            return !1;
          }
        },
        ...
        o = function (m, p, v) {
          if (!I.defined(m)) return !1;
          try {
            return o1(e, t, { key: m, actual: p, previous: v, type: 'decreased' });
          } catch {
            return !1;
          }
        },
        ...
        c = function (m, p, v) {
          if (!I.defined(m)) return !1;
          try {
            return o1(e, t, { key: m, actual: p, previous: v, type: 'increased' });
          } catch {
            return !1;
          }
        },
        u = function (m, p) {
          try {
            return s1(e, t, { key: m, type: 'removed', value: p });
          } catch {
            return !1;
          }
        };
        ...
        pa(n, [
          {
            ...
            value: function () {
              rt() && (this.node || this.appendNode(), Tn || this.renderPortal());
            },
          },
          {
            key: 'componentDidUpdate',
            value: function () {
              rt() && (Tn || this.renderPortal());
            },
          },
          {
    ...
    F0.propTypes = { handleClick: N.default.func.isRequired, styles: N.default.object.isRequired };
    function M0(e) {
      var t = e.content,
        n = e.footer,
        r = e.handleClick,
      ...
      return (
        ...
        (o || l) &&
          !I.boolean(i) &&
          (c.close = a.createElement(F0, { styles: d.close, handleClick: r })),
        a.createElement(
          'div',
            ...
            value: function () {
              ...
              return (
                i
                  ...
                  : (c.content = a.createElement(M0, this.props)),
                d === ee.OPEN && u.push('__floater__open'),
                o || (c.arrow = a.createElement(N0, this.props)),
                a.createElement(
                  'div',
    ...
    var p3 = { zIndex: 100 };
    function h3(e) {
      var t = (0, Pi.default)(p3, e.options || {});
      return {
        wrapper: {
          cursor: 'help',
          display: 'inline-flex',
                ...
                if (rt()) {
                  ...
                  (r.wrapperOptions.position !== c.position || r.target !== d) &&
                    ...
                    this.floaterRef &&
                      ...
                      u3(this.floaterRef, 'transitionend', this.handleTransitionEnd),
            ...
            },
            {
              ...
              value: function () {
                ...
                if (l) {
                  ...
                  new r1(this.target, this.wrapperRef, {
    ...
    xe(yl, 'propTypes', {
      ...
      children: N.default.node,
      component: h1(N.default.oneOfType([N.default.func, N.default.element]), function (e) {
        return !e.content;
      }),
      content: h1(N.default.node, function (e) {
        return !e.component;
      }),
    ...
    var v3 = ht(qd(), 1),
      ...
      b3 = (e, t, n) =>
        t in e
          ? y3(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n })
          : (e[t] = n),
      O = (e, t, n) => (b3(e, typeof t != 'symbol' ? t + '' : t, n), n),
      ie = {
        INIT: 'init',
        START: 'start',
        STOP: 'stop',
    ...
    function x3(e, t, n) {
      var r;
      if (!e) return 0;
      let { offsetTop: i = 0, scrollTop: l = 0 } = (r = (0, i0.default)(e)) != null ? r : {},
    ...
    function N3(e, t) {
      ...
      return new Promise((i, l) => {
        let { scrollTop: o } = r,
          s = e > o ? e - o : o - e;
        K4.default.top(r, e, { duration: s < 100 ? 50 : n }, (d) =>
    ...
    var L3 = {
      ...
      y1 = { borderRadius: 4, position: 'absolute' };
    function O3(e, t) {
      let n = (0, Xr.default)(e ?? {}, t ?? {}),
        r = (0, Xr.default)(_3, n.options || {}),
        { width: i } = r;
      ...
      let l = {
        ...
        o = {
          ...
          beaconOuter: {
            ...
            backgroundColor: `rgba(${M3(r.primaryColor).join(',')}, 0.2)`,
          ...
          spotlight: { ...y1, backgroundColor: 'gray' },
          spotlightLegacy: {
            ...y1,
    ...
    function On(e, t) {
      var n, r, i, l, o, s;
      let d = e ?? {},
        c = Aa.default.all([T3, I3(t), d], { isMergeableObject: _.plainObject }),
        u = O3(t.styles, c.styles),
        m = Mr(Ft(c.target), c.disableScrollParentFix),
        p = Aa.default.all([
          L3,
      ...
      return (
        ...
        {
          ...c,
          locale: Aa.default.all([_0, (s = t.locale) != null ? s : {}, c.locale || {}]),
          floaterProps: p,
          styles: Q4(u, 'floaterStyles'),
        }
      );
    }
    function O0(e, t = !1) {
    ...
    var R3 = {
      ...
      E1 = ['action', 'index', 'lifecycle', 'status'],
      B3 = class {
        constructor(e) {
          O(this, 'beaconPopper'),
            ...
            O(this, 'update', (i) => {
              var l;
              if (!F3(i, E1)) throw new Error(`State is not valid. Valid keys: ${E1.join(', ')}`);
              this.setState({
                ...this.getNextState(
      ...
      `)
        ...
        render() {
          let {
            ...
            c = _.string(i.open) ? i.open : (0, v3.default)(i.open),
      ...
      z3 = class extends Tt {
        ...
        componentDidMount() {
          let {
            ...
            i = Ft(r);
          (this.scrollParent = Fr(i ?? document.body, n, !0)),
            (this.isActive = !0),
        ...
        get spotlightStyles() {
          ...
          let { showSpotlight: r } = this.state,
            ...
            p = S3(c, o, i);
          return {
            ...(v1() ? s.spotlightLegacy : s.spotlight),
        ...
        render() {
          ...
          let d = s.overlay;
          v1() && (d = o === 'center' ? s.overlayLegacyCenter : s.overlayLegacy);
          let c = {
            ...
            u = o !== 'center' && t && S(D3, { styles: this.spotlightStyles });
          if (Z0() === 'safari') {
    ...
    function G3(e) {
      let {
        ...
        { back: E, close: C, last: Z, next: F, skip: V } = y,
        D = { primary: C };
      return (
        r &&
          ((D.primary = l ? Z : F),
        ...
        (D.close = !v && S(W3, { 'data-test-id': 'button-close', styles: h.buttonClose, ...n })),
        S(
          'div',
          {
            key: 'JoyrideTooltip',
    ...
    var q3 = G3,
      ...
      K3 = class extends Tt {
        ...
        componentDidUpdate(e) {
          ...
          g('lifecycle', G.INIT, G.READY) &&
            p.update({ lifecycle: g1(m) || w ? G.TOOLTIP : G.BEACON }),
            v('index') &&
            ...
            v('lifecycle', G.TOOLTIP) &&
              ...
              this.tooltip &&
                ((this.scope = new V3(this.tooltip, { selector: '[data-action=primary]' })),
                this.scope.setFocus())),
          ...
          return !O0(s) || !_.domElement(d)
            ...
            : S(
                ...
                S(
                  ...
                  S(z3, { ...s, debug: t, lifecycle: r, onClickOverlay: this.handleClickOverlay })
                ),
                S(
                  yl,
                  {
      ...
      I0 = class extends Tt {
        constructor(e) {
          ...
          (this.store = P3({ ...e, controlled: r && _.number(i) })),
        ...
        componentDidUpdate(e, t) {
          ...
          let { action: n, controlled: r, index: i, lifecycle: l, status: o } = this.state,
            ...
            C = On(u[i], this.props),
            Z = !Fe(p, u),
            F = _.number(c) && h('stepIndex'),
            V = Ft(C.target);
          if (
            (Z && (b1(u, s) ? g(u) : console.warn('Steps are not valid', u)),
            h('run') && (d ? y(c) : w()),
            F)
          ) {
        ...
        scrollToStep(e) {
          ...
          if (r === Q.RUNNING && p) {
            ...
            (y = y >= 0 ? y : 0),
              r === Q.RUNNING &&
                N3(y, { element: g, duration: o }).then(() => {
                  setTimeout(() => {
                    var h;
    ...
    var Q3 = I0,
      ...
      cr = ([e, ...t]) => t.reduce((n, r) => (k1.indexOf(r) > k1.indexOf(n) ? r : n), e);
    function J3(e) {
      return (e.FAILED ?? 0) > 0
        ? 'FAILED'
        : (e.IN_PROGRESS ?? 0) > 0
    ...
    var X3 = (e) => {
      ...
      R0 = ({ result: e }) => e !== 'EQUAL' && e !== 'FIXED',
      e7 = (e, t) => {
        let n = e.filter((i) => i.comparisons.some(R0)),
          r = n.length ? n : e;
    ...
    function n7(e) {
      ...
      return (
        e.length &&
          ((d = t ? e7(e, i) : e.find(({ mode: u }) => u.name === i) || e[0]),
          (c = t
            ? t7(d.comparisons, o)
...
`),
      d7 = ({ projectId: e, storyId: t, gitInfo: n, selectedBuildInfo: r }) => {
        ...
        let d = o && t && o.variables.storyId !== t,
          c = rn(r7, i?.project?.lastBuildOnBranch),
          u = [
            ...rn(l7, c && 'testsForStory' in c && c.testsForStory ? c.testsForStory.nodes : []),
          ],
          m = c?.committedAt > n.committedAt,
          p = !!c && !m,
          v = !!c && u.every((y) => y.status !== 'IN_PROGRESS'),
          g = rn(i7, i?.selectedBuild ?? (v ? i?.project?.lastBuildOnBranch : void 0));
        return {
      ...
      c7 = () => ft(El, 'Build'),
      V0 = () => {
        let { selectedBuild: e } = ft(El, 'Build');
      ...
      h7 = k.div({ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }),
      f7 = k.div(({ theme: e }) => ({
        fontSize: 13,
        lineHeight: '18px',
        fontWeight: 700,
      ...
      v7 = k.div({ display: 'flex', justifyContent: 'flex-end', marginTop: 15 }),
      y7 = ({ isLastStep: e, step: t, primaryProps: n, tooltipProps: r }) =>
        a.createElement(
          p7,
          { ...r },
          a.createElement(
            h7,
            null,
            t.title && a.createElement(f7, null, t.title),
            a.createElement(g7, null, t.content)
          ),
      ...
      w1 = 'setFilter',
      b7 = ({ managerApi: e, skipWalkthrough: t, startWalkthrough: n, completeWalkthrough: r }) => {
        let i = Sn(),
          l = Wt(),
      ...
      H0 = ({ localBuildProgress: e, title: t }) =>
        a.createElement(
          E7,
          { warning: !0 },
          a.createElement(
            ...
            a.createElement(
              ...
              {
                target: '_blank',
                href: e.errorDetailsUrl || `${K1}#troubleshooting`,
                withArrow: !0,
              },
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(H0, { localBuildProgress: t }),
              e
            )
          )
        )
    ...
    JSON.stringify(C7);
    var j0 = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
        let { emoji: r, renderProgress: i } = kl[e.currentStep],
          l = i(e);
        return a.createElement(j, { ...n }, t && r, ' ', l);
      },
      S7 = k(j)({ display: 'flex', flexDirection: 'column', gap: 10, width: 200, marginTop: 15 }),
      D0 = k.div(({ theme: e }) => ({
        height: 5,
        background: e.background.hoverable,
        borderRadius: 5,
      ...
      return a.createElement(
        ...
        a.createElement(
          ...
          typeof e.buildProgressPercentage == 'number' &&
            a.createElement(x7, { style: { width: `${e.buildProgressPercentage}%` } })
        ),
        a.createElement(j0, { center: !0, muted: !0, small: !0, localBuildProgress: e })
      );
    }
    var N7 =
      ...
      Z7 = k(j)(({ theme: e }) => ({ color: e.color.darkest })),
      _7 = ({ onSkip: e, runningSecondBuild: t }) =>
        a.createElement(
          pe,
          { footer: null },
          a.createElement(
      ...
      Di = ({ backgroundColor: e, status: t, thumbnailUrl: n }) =>
        a.createElement(
          ...
          t === 'positive' && a.createElement(Qi, null)
        ),
      C1 = k(j)({ marginBottom: 5 }),
      S1 = ({ onComplete: e, onSkip: t, ranSecondBuild: n = !1 }) => {
            ...
            n
              ? a.createElement(
                  ...
                  a.createElement(
                    Et,
                    null,
                    a.createElement(C1, null, "You're ready to start testing!"),
              ...
              : a.createElement(
                  ...
                  a.createElement(
                    Et,
                    null,
                    a.createElement(C1, null, "It's time to review changes!"),
                    a.createElement(
                      re,
                      { variant: 'solid', size: 'medium', onClick: e },
                      'Take a tour'
      ...
      V7 = ({ isRunning: e, localBuildProgress: t, startBuild: n, onSkip: r }) => (
          ...
          : t?.currentStep === 'limited'
            ...
            : c && (!t || (t && s))
              ...
              : t?.currentStep === 'complete' && !m && !w
                ? i
                  ? a.createElement(S1, { onComplete: l, onSkip: o })
                ...
                : m && !i
                  ...
                  : i
                    ? a.createElement(S1, { onComplete: l, onSkip: o, ranSecondBuild: m && w })
                    : null;
      },
      z7 = k.div(({ theme: e }) => ({
      ...
      U7 = Ct({ from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(359deg)' } }),
      $7 = k(fs)({ animation: `${U7} 1s linear infinite` }),
      Ta = { width: 10, marginRight: 8 },
      N1 = k.button(({ isWarning: e, onClick: t, theme: n }) => {
      ...
      F1 = k.div(({ isWarning: e, percentage: t, theme: n }) => {
      ...
      W7 = k(Vc)({ transition: 'transform 0.1s ease-in-out' }),
      G7 = k.div(({ expanded: e, theme: t }) => ({
        display: 'grid',
      ...
      Y7 = k.div(({ isCurrent: e, isFailed: t, isPending: n, theme: r }) => ({
        display: 'flex',
        flexDirection: 'row',
        gap: 8,
        opacity: n ? 0.7 : 1,
      ...
      K7 = ({ localBuildProgress: e, expanded: t = !1 }) => {
        ...
        let r = ['aborted', 'error'].includes(e.currentStep),
          i = ji.map((l) => {
            ...
            return c
              ? { ...m, icon: a.createElement(on, { style: Ta }), renderLabel: m.renderProgress }
              : d
                ? { ...m, icon: a.createElement($7, { style: Ta }), renderLabel: m.renderProgress }
                : u
                  ? { ...m, icon: a.createElement(Pc, { style: Ta }), renderLabel: m.renderName }
                  : {
                      ...m,
                      icon: a.createElement(Qi, { style: Ta }),
      ...
      Q7 = ({
        ...
        if (n) {
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(F1, { percentage: n.buildProgressPercentage, isWarning: m }),
              a.createElement(
                Za,
                null,
                a.createElement(j0, { localBuildProgress: n, withEmoji: !0 })
              ),
              u
                ? a.createElement(
                    ct,
                    { onClick: t },
                    a.createElement(Ji, { 'aria-label': 'Dismiss' })
                  )
                : a.createElement(
                    ct,
                    { as: 'div' },
                    a.createElement(W7, { style: { transform: `rotate(${l ? -180 : 0}deg)` } })
                  )
            ),
            a.createElement(K7, { localBuildProgress: n, expanded: l || u })
          );
        }
        function d() {
          return i
        ...
        return a.createElement(N1, { onClick: i }, a.createElement(F1, { percentage: 100 }), d());
      },
      J7 = ({ onClose: e }) =>
        a.createElement(
          Es,
          ...
          a.createElement(
            ...
            a.createElement('p', null, a.createElement(Yc, null), 'Delay: 300ms'),
            a.createElement('p', null, a.createElement(Kc, null), 'Animation pause: Ends'),
            a.createElement('p', null, a.createElement(Qc, null), 'Threshold: 0.2'),
            a.createElement('p', null, a.createElement(Jc, null), 'Anti-alias: Included')
          ),
          a.createElement(
            Ei,
            null,
            a.createElement(Ha, null, 'Bounding box', a.createElement(fo, null)),
            a.createElement(
              'dl',
              null,
      ...
      U0 = De(z0),
      $0 = () => ft(U0, 'ReviewTest'),
      X7 = ({ children: e, watchState: t = z0 }) => a.createElement(U0.Provider, { value: t }, e),
      eh = k.div(
        ({ theme: e }) => ({
          position: 'relative',
          display: 'flex',
      ...
      th = k(ne)({ margin: '30px 15px' }),
      nh = ({ comparisonImageLoaded: e, focusImageLoaded: t, showDiff: n, showFocus: r }) =>
        n && r ? e && t : n ? e : r ? t : !0,
      ah = ({
        componentName: e,
        storyName: t,
        ...
        let p = Sn(),
          ...
          [D, X] = a.useState(!1),
          oe = o ? C : f,
          ge = nh({ comparisonImageLoaded: F, focusImageLoaded: D, showDiff: b, showFocus: h });
        return a.createElement(
          eh,
          { ...m, ...w },
          i &&
          ...
          v && a.createElement(hs, null),
          g &&
            !i &&
            a.createElement(
              th,
              null,
              a.createElement(kc, { color: p.base === 'light' ? 'currentColor' : p.color.medium }),
              a.createElement(
                j,
                { center: !0, muted: !0 },
      ...
      G0 = ({ status: e }) => a.createElement(W0, { status: e }),
      ih = k.div({
        position: 'relative',
        display: 'inline-flex',
        justifyContent: 'center',
      ...
      q0 = ({ status: e, children: t }) =>
        a.createElement(ih, null, t, a.createElement(W0, { overlay: !0, status: e })),
      A1 = {
        CHROME: a.createElement(Qs, { alt: 'Chrome' }),
        FIREFOX: a.createElement(Js, { alt: 'Firefox' }),
        SAFARI: a.createElement(Xs, { alt: 'Safari' }),
        EDGE: a.createElement(rh, { alt: 'Edge' }),
      },
      lh = k.div(({ theme: e }) => ({
        alignItems: 'center',
        color: e.base === 'light' ? e.color.dark : e.color.light,
      ...
      oh = ({ isAccepted: e, selectedBrowser: t, browserResults: n, onSelectBrowser: r }) => {
        let i = cr(n.map(({ result: s }) => s));
        if (!i) return null;
        let l = A1[t.key];
        !e && i !== 'EQUAL' && n.length >= 2 && (l = a.createElement(q0, { status: i }, l));
        let o =
          n.length > 1 &&
          n.map(({ browser: s, result: d }) => ({
            ...
            id: s.id,
            onClick: () => r(s),
            right: !e && d !== 'EQUAL' && a.createElement(G0, { status: d }),
            icon: A1[s.key],
            title: s.name,
          }));
        return a.createElement(
          ...
          o
            ? a.createElement(
                ...
                l,
                a.createElement(L1, null, t.name),
                a.createElement(Xi, { size: 10 })
              )
            : a.createElement(lh, null, l, a.createElement(L1, null, t.name))
        );
      },
      sh = k.div(({ theme: e }) => ({
        alignItems: 'center',
      ...
      ch = ({ isAccepted: e, modeOrder: t, modeResults: n, onSelectMode: r, selectedMode: i }) => {
        let l = cr(n.map(({ result: d }) => d));
        if (!l) return null;
        let o = a.createElement(Rc, null);
        !e && l !== 'EQUAL' && n.length >= 2 && (o = a.createElement(q0, { status: l }, o));
        let s =
          n.length > 1 &&
          n
            .map(({ mode: d, result: c }) => ({
              id: d.name,
              title: d.name,
              right: !e && c !== 'EQUAL' && a.createElement(G0, { status: c }),
              onClick: () => r(d),
        ...
        return a.createElement(
          ...
          s
            ? a.createElement(
                ...
                o,
                a.createElement(T1, null, i.name),
                a.createElement(Xi, { size: 10 })
              )
            : a.createElement(sh, null, o, a.createElement(T1, null, i.name))
        );
      },
      Z1 = () => {
        let e = Wt(),
      ...
      _1 = k.div({ display: 'flex', flexDirection: 'row' }),
      ur = k.div(
        ({ theme: e }) => ({
          width: 12,
          height: 12,
      ...
      hh = k.div(({ theme: e, showDivider: t }) => ({
        gridArea: 'actions',
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'flex-end',
      ...
      fh = ({ isOutdated: e }) => {
        let { baselineImageVisible: t, diffVisible: n, focusVisible: r } = vr(),
          { toggleBaselineImage: i, toggleDiff: l, toggleFocus: o } = yn(),
            ...
            a.createElement(
              ...
              !(w && y) &&
                a.createElement(
                  ...
                  a.createElement(ph, null, a.createElement(Zc, null))
                ),
              a.createElement(
                Ee,
                {
                ...
                a.createElement(
                  ...
                  e ? a.createElement(fr, null) : a.createElement(fs, null)
                )
              )
            )
        );
      ...
      vh = ({ icon: e }) => {
        let { color: t } = Sn();
        return {
          passed: a.createElement(Lc, { style: { ...ii, color: t.positive } }),
          changed: a.createElement(Tc, { style: { ...ii, color: t.warning } }),
          failed: a.createElement(on, { style: { ...ii, color: t.negative } }),
        }[e];
      };
    function zi(e) {
    ...
    var Sh = {
      ...
      xh = { full: 'h:mm:ss a zzzz', long: 'h:mm:ss a z', medium: 'h:mm:ss a', short: 'h:mm a' },
      Nh = {
        full: "{{date}} 'at' {{time}}",
        long: "{{date}} 'at' {{time}}",
        medium: '{{date}}, {{time}}',
      ...
      Fh = {
        date: li({ formats: Sh, defaultWidth: 'full' }),
        time: li({ formats: xh, defaultWidth: 'full' }),
        dateTime: li({ formats: Nh, defaultWidth: 'full' }),
      },
      Mh = Fh,
      Ah = {
    ...
    var Zh = {
      ...
      Vh = {
        ordinalNumber: Ph,
        era: In({ values: Zh, defaultWidth: 'wide' }),
        quarter: In({
          values: _h,
          defaultWidth: 'wide',
        ...
        month: In({ values: Oh, defaultWidth: 'wide' }),
        day: In({ values: Ih, defaultWidth: 'wide' }),
        dayPeriod: In({
          values: Rh,
          defaultWidth: 'wide',
          formattingValues: Bh,
    ...
    var Uh = /^(\d+)(th|st|nd|rd)?/i,
      ...
      Gh = { any: [/^b/i, /^(a|c)/i] },
      qh = { narrow: /^[1234]/i, abbreviated: /^q[1234]/i, wide: /^[1234](th|st|nd|rd)? quarter/i },
      Yh = { any: [/1/i, /2/i, /3/i, /4/i] },
      Kh = {
        narrow: /^[jfmasond]/i,
    ...
    function o6(e, t, n) {
      ...
      var c = K0(l6(n), { addSuffix: !!n?.addSuffix, comparison: d }),
        u,
        m;
      d > 0 ? ((u = nn(t)), (m = nn(e))) : ((u = nn(e)), (m = nn(t)));
    ...
    function s6(e, t) {
      return Lr(1, arguments), o6(e, Date.now(), t);
    }
    var d6 = {
    ...
    var u6 = (e) => s6(e, { addSuffix: !0, locale: { ...Y0, formatDistance: c6 } }),
      Bn = k.div(({ theme: e }) => ({
        gridArea: 'info',
        display: 'flex',
        justifySelf: 'start',
  ...
  `,
      ...
      D1 = k.div({ gridArea: 'footer', position: 'sticky', zIndex: 1, bottom: 0 }),
      f6 = k.div(({ children: e, theme: t }) => ({
        display: 'flex',
        alignItems: 'center',
      ...
      v6 = ({
        ...
        let { baselineImageVisible: s, diffVisible: d, focusVisible: c } = vr(),
          { toggleBaselineImage: u, toggleSettings: m, toggleWarnings: p } = yn(),
          v = V0(),
          ...
          F = !Z && E?.result === 'ADDED' && E?.status !== 'ACCEPTED',
        ...
        te(() => {
          (b.current !== o ||
            ...
            (b.current = o),
            (f.current = v.id);
        }, [v.id, o, y, u, m, p, Z, F, V]);
        let D = a.createElement(p6, {
          tests: w,
          startedAt: g,
          isStarting: t,
          isBuildFailed: n,
        ...
        if (t || !w.length)
          return a.createElement(
            H1,
            { hidden: l },
            a.createElement(j1, null, a.createElement(V1, null, D)),
            a.createElement(D1, null, a.createElement(Z1, null))
          );
        let X = bl(w),
          { isInProgress: oe } = X,
          ge =
        ...
        return a.createElement(
          ...
          a.createElement(
            j1,
            null,
            a.createElement(V1, null, D, a.createElement(fh, { isOutdated: e }))
          ),
          a.createElement(
            h6,
            null,
            ...
            !oe &&
              ...
              a.createElement(
                ...
                a.createElement(g6, null, ge.stack || ge.message)
              )
          ),
          a.createElement(D1, null, a.createElement(Z1, null))
        );
      },
      y6 = k(Tl)({ padding: '4px 8px', margin: '0 6px' }),
      b6 = ({ onClose: e }) =>
        a.createElement(
          Es,
          null,
          a.createElement(
            ...
            a.createElement(
              ...
              null,
              'Warnings',
              a.createElement(y6, { status: 'warning' }, '2'),
              a.createElement(tl, { onClick: e }, a.createElement(el, { 'aria-label': 'Close' }))
            ),
            a.createElement(
              'p',
            ...
            a.createElement(
              'p',
              null,
              a.createElement(re, { variant: 'outline' }, a.createElement(ms, null), 'Docs'),
              a.createElement(re, { variant: 'outline' }, a.createElement(Oc, null), 'Get support')
            )
          )
        );
    k.div(({ theme: e }) => ({
    ...
    var E6 = ({
        ...
        let { settingsVisible: o, warningsVisible: s } = vr(),
          { toggleSettings: d, toggleWarnings: c } = yn(),
          ...
          w = V0(),
          b = Wt(),
          { buildIsReviewable: h, userCanReview: f } = $0(),
          E = !!(!h && g && y && i),
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              Hn,
              { grow: !0, hidden: !o },
              a.createElement(J7, { onClose: () => d(!1) })
            ),
            a.createElement(
              Hn,
              { grow: !0, hidden: !s },
            ...
            return i
              ? i.currentStep === 'error'
                ? a.createElement(
                    a.Fragment,
                    null,
                    a.createElement(H0, { localBuildProgress: i, title: 'Build failed' }),
                    v
                  )
              ...
              ? a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        si,
                        { withArrow: !0, href: `${K1}#troubleshooting`, target: '_blank' },
                        'Troubleshoot'
                      )
                    )
                  )
...
`),
      S6 = ({ lastBuildOnBranch: e, vtaOnboarding: t }) => {
        let n = Zt(),
      ...
      x6 = ({
        ...
        let u = Zt(),
          ...
          g = d7({ projectId: s, storyId: c, gitInfo: d, selectedBuildInfo: t }),
          {
            account: y,
            features: w,
            manageUrl: b,
            ...
            onReviewError: (Gt, ld) => {
              Gt instanceof Error &&
                m({
                  ...
                  content: {
                    headline: `Failed to ${ld.status === 'ACCEPTED' ? 'accept' : 'unaccept'} changes`,
        ...
        te(() => l(!D), [D, l]);
        let ye =
            C && 'testsForStatus' in C && C.testsForStatus?.nodes && rn(B0, C.testsForStatus.nodes),
          we = F ? Z4(ye || []) : [];
        te(() => {
          o(we);
        }, [JSON.stringify(we), o]),
          te(() => {
            n((Gt) =>
              _4(Gt, {
                shouldSwitchToLastBuildOnBranch: F && Z,
        ...
        let He = K(() => C?.id && F && n({ buildId: C.id, storyId: c }), [n, F, C?.id, c]),
          {
            showOnboarding: je,
            showGuidedTour: X0,
            completeOnboarding: ed,
            completeWalkthrough: td,
            skipOnboarding: nd,
            skipWalkthrough: ad,
            startWalkthrough: rd,
            lastBuildHasChangesForStory: id,
          } = S6(g);
        return w && !w.uiTests
          ? a.createElement(O4, { manageUrl: b })
          : y?.suspensionReason
            ? a.createElement(n0, {
          ...
          u = gt(
            () =>
              bi(
                'startBuild',
                () => {
                  s(!1), l(!0), n(Jd, { accessToken: t }), r?.({ action: 'startBuild' });
                },
                1e3,
                !1
              ),
          ...
          m = gt(
            () =>
              bi(
                'startBuild',
                () => {
                  d ? (l(!1), n(Xd), r?.({ action: 'stopBuild' })) : s(!0);
                },
                1e3,
                !1
              ),
        ...
        return async (t, { signal: n, ...r } = {}) => {
          ...
          return (
            n?.addEventListener('abort', () => {
              e(r5, { requestId: i }), Jt.get(i)?.reject(n.reason), Jt.delete(i);
            }),
            e(i5, { requestId: i, input: t, init: r }),
            new Promise((l, o) => {
      ...
      M6 = ({ active: e }) => {
        let [t, n] = Vs(),
          r = K(
            (je) => {
              n(je), je || $c('authenticationScreen', 'exchangeParameters');
            },
            [n]
          ),
          { storyId: i } = wn(),
        ...
        if (!e) return we(null);
        if (globalThis.CONFIG_TYPE !== 'DEVELOPMENT') return we(a.createElement(F4, null));
        if (F) return we(a.createElement(A4, null));
        if (s) return we(a.createElement(M4, { offline: s }));
        if (!t)
          return we(
            a.createElement(s4, { setAccessToken: r, setCreatedProjectId: Z, hasProjectId: !!y })
          );
        if (o || !l) return we(a.createElement(p4, { gitInfoError: o }));
        if (g) return e ? a.createElement(yi, null) : null;
        if (!y)
          return we(
            a.createElement(C4, { createdProjectId: C, setCreatedProjectId: Z, onUpdateProject: b })
          );
        if (h) {
          if (!w) throw new Error('Missing config file after configuration failure');
          return we(a.createElement(k4, { projectId: y, configFile: w }));
        }
        if (f) {
          if (!w) throw new Error('Missing config file after configuration success');
          return we(a.createElement(v4, { projectId: y, configFile: w, goToNext: E }));
        }
      ...
      di = ht(Ui()),
      A6 = k.div({ display: 'flex', justifyContent: 'space-between', padding: '8px 0' }),
      L6 = k.div({ display: 'flex', flexDirection: 'column', marginLeft: 8 }),
      T6 = k.div({ display: 'flex', gap: 4 }),
      Z6 = k.div(({ crashed: e, theme: t }) => ({
        fontSize: t.typography.size.s1,
        fontWeight: e ? 'bold' : 'normal',
        color: e ? t.color.negativeText : t.color.defaultText,
      })),
      _6 = k.div(({ theme: e }) => ({ fontSize: e.typography.size.s1, color: e.textMutedColor })),
      O6 = k(Ol)({ margin: 4 }),
      I6 = k(wc)({ width: 10 }),
      R6 = () => {
        let { addNotification: e, selectStory: t, setOptions: n, togglePanel: r } = Zt(),
          ...
          { startBuild: C, stopBuild: Z } = Q0({ localBuildProgress: p, accessToken: s }),
          F;
        ...
        let X = K(
            (ce) => {
              if ((n({ selectedPanel: ln }), r(!0), b && f !== 'story')) {
        ...
        switch (!0) {
          case !!F:
            fe = a.createElement(_t, { onClick: ge }, F);
            break;
    ...
    ga.register(U, (e) => {
      ga.add(ln, {
        ...
        render: ({ active: t }) => a.createElement(M6, { active: !!t, api: e }),
      }),
        globalThis.CONFIG_TYPE === 'DEVELOPMENT' &&
          (va(U).onSelect(() => {
            e.setSelectedPanel(ln), e.togglePanel(!0);
          }),
          ga.add(ci, {
            type: Tr.experimental_TEST_PROVIDER,
            render: () => a.createElement(R6, null),
          }));
    });
  })();
} catch (e) {
