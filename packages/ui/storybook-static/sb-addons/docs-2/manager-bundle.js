...
`,
    ...
    function T(e) {
      ...
      var o = _e.exec(t.substring(0, 50));
      if (o)
        return {
          red: parseInt('' + o[1], 10),
    ...
    function Ae(e, t) {
      if (t === 'transparent') return t;
      var r = g(t);
      return y(d({}, r, { lightness: w(0, 1, r.lightness - parseFloat(e)) }));
    }
    m(Ae);
    function Me(e, t) {
      if (t === 'transparent') return t;
      var r = g(t);
      return y(d({}, r, { saturation: w(0, 1, r.saturation - parseFloat(e)) }));
    }
    m(Me);
    function Be(e, t) {
      if (t === 'transparent') return t;
    ...
    function Le(e, t) {
      ...
      var r = T(t),
        ...
        n = d({}, r, { alpha: w(0, 1, (a * 100 + parseFloat(e) * 100) / 100) });
      return F(n);
    }
    m(Le);
    function $e(e, t) {
    ...
    function Ke(e, t) {
      ...
      var r = T(t),
        a = typeof r.alpha == 'number' ? r.alpha : 1,
        n = d({}, r, { alpha: w(0, 1, +(a * 100 - parseFloat(e) * 100).toFixed(2) / 100) });
      return F(n);
    }
    var Ze = m(Ke),
      Je = Ze,
      ...
      H.add(ue, {
        ...
        render: ({ active: t }) => {
          let r = e.getChannel(),
            ...
            n = r?.last(ae)?.[0],
            [o, s] = G({ source: n?.source, format: n?.format ?? void 0 }),
